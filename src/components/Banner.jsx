      ...
      <div className="container mx-auto w-[60%] mt-20 flex md:justify-between items-center">
        ...
        <div className="space-y-5">
          ...
          <div className="md:flex">
            <button className=" bg-gradient-to-r from-[#4f39f6] to-[#9514fa] text-white rounded-full mb-2 mr-3 p-2 cursor-pointer hover:text-xl text-xs">
              Explore Products
            </button>
            <button className="flex items-center text-purple-500 border border-purple-300 rounded-full pr-2 cursor-pointer hover:text-xl text-xs">
              <img src={btnImg} alt="" />
              Watch Demo
            </button>
          </div>
